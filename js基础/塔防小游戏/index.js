  ...
  init: function (t, i) {
    ...
    var e,
      s = {
        ...
        start: function () {
          clearTimeout(this._st), s.log("Start!");
          var t = this;
          return (
            ...
            (this.stage = new s.Stage(
              "stage-main",
              s.getDefaultStageData("stage_main")
            )),
        ...
        step: function () {
          if (
            (this.is_debug &&
              _TD &&
              _TD.cheat &&
              (this.checkCheat(_TD.cheat), (_TD.cheat = "")),
            !this.is_paused)
          ) {
            if ((this.iframe++, this.iframe % 50 == 0)) {
    ...
    for (e = 0; this.a[e]; e++) this.a[e](s);
    delete this.a, s.init(t);
  },
};
_TD.a.push(function (t) {
  t.lang = {
    ...
    strLeft: function (t, i) {
      ...
      switch ((s -= e.length)) {
        ...
        default:
          var n = i - s,
            h = t.slice(n, i),
            a = h.replace(/[\x00-\xff]/g, "").length;
          return a
            ? t.slice(0, n) + this.arguments.callee(h, a)
            : t.slice(0, n);
      }
    },
    strLen2: function (t) {
    ...
    rndStr: function (t) {
      ...
      var i,
        ...
        h = s.length;
      for (i = 0; t > i; i++)
        (e = Math.floor(Math.random() * h)), n.push(s.substr(e, 1));
      return n.join("");
    },
    nullFunc: function () {},
    ...
    mix: function (t, i, e) {
      if (!i || !t) return t;
      for (var s in i)
        !i.hasOwnProperty(s) || (e === !1 && s in t) || (t[s] = i[s]);
      return t;
    },
  };
}),
  _TD.a.push(function (t) {
    t.eventManager = {
      ...
      step: function () {
        if (this.current_type) {
          var i,
            ...
            o = [];
          for (i in this._registers)
            this._registers.hasOwnProperty(i) &&
              ((e = this._registers[i]),
              (s = e[0]),
              (n = e[1]),
              (h = e[2]),
              s.is_valid
                ? s.is_visiable &&
                  ((l = this.isOn(s)),
                  "click" != this.current_type
                    ? "hover" == n && s.is_hover && l
                      ? (h(), (this.current_type = "hover"))
                      : "enter" == n && !s.is_hover && l
                      ? ((s.is_hover = !0), h(), (this.current_type = "enter"))
                      : "out" == n &&
                        s.is_hover &&
                        !l &&
                        ((s.is_hover = !1), h(), (this.current_type = "out"))
                    : l && "click" == n && h())
                : o.push(s));
      ...
      hover: function (t, i) {
        "click" != this.current_type &&
          ((this.current_type = "hover"), (this.ex = t), (this.ey = i));
      },
      click: function (t, i) {
  ...
  _TD.a.push(function (t) {
    (t.Stage = function (i, e) {
      (this.id = i || "stage-" + t.lang.rndStr()),
        ...
        (this._step2 = t.lang.nullFunc),
        this._init();
    }),
      (t.Stage.prototype = {
        _init: function () {
          "function" == typeof this.cfg.init && this.cfg.init.call(this),
            "function" == typeof this.cfg.step2 &&
              (this._step2 = this.cfg.step2);
        },
        start: function () {
          (this.state = 1),
            t.lang.each(this.acts, function (t) {
              t.start();
            });
        },
        pause: function () {
        ...
        step: function () {
          1 == this.state &&
            this.current_act &&
            (t.eventManager.step(), this.current_act.step(), this._step2());
        },
        render: function () {
          0 != this.state &&
            3 != this.state &&
  ...
  _TD.a.push(function (t) {
    (t.Act = function (i, e) {
      ...
      (t.Act.prototype = {
        ...
        start: function () {
          return this.stage.current_act && 3 != this.stage.current_act.state
            ? ((this.state = 0), void this.stage.current_act.queue(this.start))
            : ((this.state = 1),
              (this.stage.current_act = this),
              void t.lang.each(this.scenes, function (t) {
                t.start();
              }));
        },
        pause: function () {
        ...
        clear: function () {
          (this.state = 3),
            t.lang.each(this.scenes, function (t) {
              t.clear();
            });
        },
        step: function () {
  ...
  _TD.a.push(function (t) {
    (t.Scene = function (i, e) {
      ...
      (t.Scene.prototype = {
        ...
        start: function () {
          return this.act.current_scene &&
            this.act.current_scene != this &&
            3 != this.act.current_scene.state
            ? ((this.state = 0), void this.act.current_scene.queue(this.start))
            : ((this.state = 1), void (this.act.current_scene = this));
        },
        pause: function () {
          this.state = 2;
        },
        ...
        render: function () {
          if (0 != this.state && 3 != this.state) {
            var i,
              ...
              s = t.ctx;
            for (
              s.clearRect(0, 0, this.stage.width, this.stage.height), i = 0;
              10 > i;
              i++
            ) {
              e = [];
        ...
        addElement: function (t, i, e) {
          (i = i || t.step_level || 1),
            (e = e || t.render_level),
            this._step_elements[i].push(t),
            this._render_elements[e].push(t),
            (t.scene = this),
            (t.step_level = i),
            (t.render_level = e);
        },
  ...
  _TD.a.push(function (t) {
    (t.Element = function (i, e) {
      (this.id = i || "el-" + t.lang.rndStr()),
        (this.cfg = e || {}),
        (this.is_valid = !0),
        (this.is_visiable =
          "undefined" != typeof e.is_visiable ? e.is_visiable : !0),
        (this.is_paused = !1),
        (this.is_hover = !1),
        (this.x = this.cfg.x || -1),
        (this.y = this.cfg.y || -1),
        ...
        (this.step_level = e.step_level || 1),
        (this.render_level = e.render_level),
        (this.on_events = e.on_events || []),
        this._init();
    }),
      (t.Element.prototype = {
        _init: function () {
          var t,
            ...
            e,
            s = this;
          for (t = 0, e = this.on_events.length; e > t; t++)
            switch ((i = this.on_events[t])) {
              case "enter":
        ...
        addToScene: function (i, e, s, n) {
          (this.scene = i),
            isNaN(e) ||
              ((this.step_level = e || this.step_level),
              (this.render_level = s || this.render_level),
              n &&
                t.lang.each(n, function (t) {
                  i.addElement(t, e, s);
                }),
  ...
  _TD.a.push(function (t) {
    ...
    var e = 20,
      s = {
        _init: function (s) {
          (s = s || {}),
            (this.grid_x = s.grid_x || 10),
            (this.grid_y = s.grid_y || 10),
            (this.x = s.x || 0),
            (this.y = s.y || 0),
            (this.width = this.grid_x * t.grid_size),
            (this.height = this.grid_y * t.grid_size),
            (this.x2 = this.x + this.width),
            ...
            (this.bullets = []),
            (this.scene = s.scene),
            (this.is_main_map = !!s.is_main_map),
            (this.select_hl = t.MapSelectHighLight(this.id + "-hl", {
              map: this,
            })),
          ...
          var n,
            h,
            a,
            l = this.grid_x * this.grid_y,
            r = s.grid_data || [];
          for (n = 0; l > n; n++)
            (h = r[n] || {}),
              (h.mx = n % this.grid_x),
              (h.my = Math.floor(n / this.grid_x)),
              (h.map = this),
              (h.step_level = this.step_level),
              (h.render_level = this.render_level),
              (a = new t.Grid(this.id + "-grid-" + h.mx + "-" + h.my, h)),
              this.grids.push(a);
          s.entrance &&
            s.exit &&
            !t.lang.arrayEqual(s.entrance, s.exit) &&
            ((this.entrance = this.getGrid(s.entrance[0], s.entrance[1])),
            (this.entrance.is_entrance = !0),
            (this.exit = this.getGrid(s.exit[0], s.exit[1])),
            (this.exit.is_exit = !0));
          var c = this;
          s.grids_cfg &&
            t.lang.each(s.grids_cfg, function (t) {
              var i = c.getGrid(t.pos[0], t.pos[1]);
              i &&
                (isNaN(t.passable_flag) || (i.passable_flag = t.passable_flag),
                isNaN(t.build_flag) || (i.build_flag = t.build_flag),
                t.building && i.addBuilding(t.building));
            });
        },
        checkHasWeapon: function () {
          this.has_weapon =
            null !=
            this.anyBuilding(function (t) {
              return t.is_weapon;
            });
        },
        ...
        preBuild: function (i) {
          (t.mode = "build"),
            this.pre_building && this.pre_building.remove(),
            (this.pre_building = new t.Building(
              this.id + "-pre-building-" + t.lang.rndStr(),
              {
                type: i,
                map: this,
                is_pre_building: !0,
        ...
        clearInvalidElements: function () {
          if (this._wait_clearInvalidElements > 0)
            return void this._wait_clearInvalidElements--;
          this._wait_clearInvalidElements = e;
          var i = [];
          t.lang.shift(this.buildings, function (t) {
            ...
            (this.buildings = i),
            (i = []),
            t.lang.shift(this.monsters, function (t) {
              t.is_valid && i.push(t);
            }),
            (this.monsters = i),
            (i = []),
            t.lang.shift(this.bullets, function (t) {
              t.is_valid && i.push(t);
            }),
            (this.bullets = i);
        },
        ...
        step: function () {
          if ((this.clearInvalidElements(), this._wait_add_monsters > 0))
        ...
        render: function () {
          ...
          (i.strokeStyle = "#99a"),
            ...
            i.beginPath(),
            i.strokeRect(this.x + 0.5, this.y + 0.5, this.width, this.height),
            i.closePath(),
            i.stroke();
        },
        onOut: function () {
    ...
    var n = {
      _init: function (i) {
        (this.map = i.map),
          (this.width = t.grid_size + 2),
          (this.height = t.grid_size + 2),
          (this.is_visiable = !1);
      },
      show: function (t) {
      ...
      render: function () {
        ...
        (i.lineWidth = 2),
          (i.strokeStyle = "#f93"),
          i.beginPath(),
          i.strokeRect(this.x, this.y, this.width - 1, this.height - 1),
          i.closePath(),
          i.stroke();
      },
    };
    ...
    var h = {
      ...
      render: function () {
        ...
        (i.fillStyle = "#fff"),
          i.beginPath(),
          i.fillRect(0, 0, this.x1, this.h),
          i.fillRect(0, 0, this.w, this.y1),
          i.fillRect(0, this.y2, this.w, this.h2),
          i.fillRect(this.x2, 0, this.w2, this.h),
          i.closePath(),
          i.fill();
      },
    };
    ...
    var i = {
      _init: function (i) {
        (i = i || {}),
          ...
          (this.mx = i.mx),
          (this.my = i.my),
          (this.width = t.grid_size),
          (this.height = t.grid_size),
          (this.is_entrance = this.is_exit = !1),
      ...
      caculatePos: function () {
        (this.x = this.map.x + this.mx * t.grid_size),
          (this.y = this.map.y + this.my * t.grid_size),
          (this.x2 = this.x + t.grid_size),
          (this.y2 = this.y + t.grid_size),
          (this.cx = Math.floor(this.x + t.grid_size / 2)),
          (this.cy = Math.floor(this.y + t.grid_size / 2));
      },
      checkBlock: function () {
        if (this.is_entrance || this.is_exit)
          return (this._block_msg = t._t("entrance_or_exit_be_blocked")), !0;
        var i,
          e = this,
          s = new t.FindWay(
            this.map.grid_x,
        ...
        return (
          (i = s.is_blocked),
          i
            ? (this._block_msg = t._t("blocked"))
            : ((i = !!this.map.anyMonster(function (t) {
                return t.chkIfBlocked(e.mx, e.my);
              })),
              i && (this._block_msg = t._t("monster_be_blocked"))),
          i
        );
      },
      buyBuilding: function (i) {
        ...
        t.money >= e
          ? ((t.money -= e), this.addBuilding(i))
          : (t.log(t._t("not_enough_money", [e])),
            this.scene.panel.balloontip.msg(
              t._t("not_enough_money", [e]),
              this
            ));
      },
      addBuilding: function (i) {
        ...
        e.locate(this),
          this.scene.addElement(e, this.step_level, this.render_level + 1),
          this.map.buildings.push(e),
          (this.building = e),
          (this.build_flag = 2),
          this.map.checkHasWeapon(),
          this.map.pre_building && this.map.pre_building.hide();
      },
      removeBuilding: function () {
        2 == this.build_flag && (this.build_flag = 1),
          this.building && this.building.remove(),
          (this.building = null);
      },
      ...
      render: function () {
        var i = t.ctx,
          ...
          s = this.y + 0.5;
        this.is_hover &&
          ((i.fillStyle = "rgba(255, 255, 200, 0.2)"),
          i.beginPath(),
          i.fillRect(e, s, this.width, this.height),
          i.closePath(),
          i.fill()),
          0 == this.passable_flag &&
            ((i.fillStyle = "#fcc"),
            i.beginPath(),
            i.fillRect(e, s, this.width, this.height),
            i.closePath(),
            i.fill()),
          (this.is_entrance || this.is_exit) &&
            ((i.lineWidth = 1),
            (i.fillStyle = "#ccc"),
            i.beginPath(),
            i.fillRect(e, s, this.width, this.height),
            ...
            i.fill(),
            (i.strokeStyle = "#666"),
            (i.fillStyle = this.is_entrance ? "#fff" : "#666"),
            i.beginPath(),
            i.arc(this.cx, this.cy, 0.325 * t.grid_size, 0, 2 * Math.PI, !0),
            i.closePath(),
            i.fill(),
            i.stroke()),
          (i.strokeStyle = "#eee"),
          (i.lineWidth = 1),
          i.beginPath(),
          i.strokeRect(e, s, this.width, this.height),
          i.closePath(),
          i.stroke();
      },
      onEnter: function () {
        if (this.map.is_main_map && "build" == t.mode)
          1 == this.build_flag
            ? (this.map.pre_building.show(), this.map.pre_building.locate(this))
          ...
          this.is_entrance
            ...
            : 0 == this.passable_flag
            ? (i = t._t("_cant_pass"))
            : 0 == this.build_flag && (i = t._t("_cant_build")),
            i && this.scene.panel.balloontip.msg(i, this);
        }
      },
      onOut: function () {
        this.scene.panel.balloontip.el == this &&
          this.scene.panel.balloontip.hide();
      },
      onClick: function () {
        1 == this.scene.state &&
          ("build" == t.mode && this.map.is_main_map && !this.building
            ? this.checkBlock()
              ? this.scene.panel.balloontip.msg(this._block_msg, this)
              : this.buyBuilding(this.map.pre_building.type)
            : !this.building &&
              this.map.selected_building &&
  ...
  _TD.a.push(function (t) {
    var i = {
      ...
      getUpgradeCost: function () {
        return Math.floor(0.75 * this.money);
      },
      getSellMoney: function () {
        return Math.floor(0.5 * this.money) || 1;
      },
      toggleSelected: function () {
        ...
        var t = this;
        this.is_selected
          ? (this.map.eachBuilding(function (i) {
              i.is_selected = i == t;
            }),
            (this.map.is_main_map
              ? this.scene.panel_map
              : this.scene.map
            ).eachBuilding(function (t) {
          ...
          : (this.map.selected_building == this &&
              (this.map.selected_building = null),
            this.map.is_main_map || this.scene.map.cancelPreBuild()),
          this.map.is_main_map &&
            (this.map.selected_building
      ...
      updateBtnDesc: function () {
        (this.scene.panel.btn_upgrade.desc = t._t("upgrade", [
          t._t("building_name_" + this.type),
          this.level + 1,
          this.getUpgradeCost(),
        ])),
          (this.scene.panel.btn_sell.desc = t._t("sell", [
            t._t("building_name_" + this.type),
            this.getSellMoney(),
          ]));
      },
      locate: function (i) {
        (this.grid = i),
          ...
          (this._fire_wait = Math.floor(
            Math.max(2 / (this.speed * t.global_speed), 1)
          )),
      ...
      findTaget: function () {
        if (this.is_weapon && !this.is_pre_building && this.grid) {
          ...
          (this.target &&
            ...
            Math.pow(this.target.cx - i, 2) + Math.pow(this.target.cy - e, 2) <=
              s) ||
            (this.target = t.lang.any(
              t.lang.rndSort(this.map.monsters),
              function (t) {
      ...
      fire: function () {
        if (this.target && this.target.is_valid) {
          if ("laser_gun" == this.type)
            return void this.target.beHit(this, this.damage);
      ...
      _upgrade2: function (i) {
        ...
        e &&
          !isNaN(e) &&
          ((e = h(this.level, e)),
          this[s] && !isNaN(this[s]) && this[s] < e && (e = this[s]),
          (this._upgrade_records[i] = e),
          (this[i] = Math.floor(e)));
      },
      upgrade: function () {
        this._upgrade_records || (this._upgrade_records = {});
        var i,
          e = ["damage", "range", "speed", "life", "shield"],
          s = e.length;
      ...
      tryToUpgrade: function (i) {
        var e = this.getUpgradeCost(),
          s = "";
        e > t.money
          ? (s = t._t("not_enough_money", [e]))
          : ((t.money -= e),
            (this.money += e),
            this.upgrade(),
            (s = t._t("upgrade_success", [
              t._t("building_name_" + this.type),
              this.level,
              this.getUpgradeCost(),
            ]))),
          this.updateBtnDesc(),
          this.scene.panel.balloontip.msg(s, i);
      },
      tryToSell: function () {
        this.is_valid &&
          ((t.money += this.getSellMoney()),
      ...
      render: function () {
        if (this.is_visiable && !(this.wait_blink < 0)) {
          ...
          t.renderBuilding(this),
            this.map.is_main_map &&
              (this.is_selected ||
                this.is_pre_building ||
                this.map.show_all_ranges) &&
              this.is_weapon &&
              this.range > 0 &&
              this.grid &&
              ((i.lineWidth = _TD.retina),
              (i.fillStyle = "rgba(187, 141, 32, 0.15)"),
              (i.strokeStyle = "#bb8d20"),
              i.beginPath(),
            ...
            "laser_gun" == this.type &&
              ...
              (i.strokeStyle = "rgba(50, 50, 200, 0.5)"),
              i.beginPath(),
      ...
      onEnter: function () {
        if (!this.is_pre_building) {
          var i = "建筑工事";
          (i = this.map.is_main_map
            ? t._t("building_info" + ("wall" == this.type ? "_wall" : ""), [
                t._t("building_name_" + this.type),
                this.level,
                this.damage,
                this.speed,
            ...
            : t._t("building_intro_" + this.type, [
                t.getDefaultBuildingAttributes(this.type).cost,
              ])),
            this.scene.panel.balloontip.msg(i, this.grid);
        }
      },
      onOut: function () {
        this.scene.panel.balloontip.el == this.grid &&
          this.scene.panel.balloontip.hide();
      },
      onClick: function () {
    ...
    var e = {
      _init: function (t) {
        (t = t || {}),
          ...
          (this.cx = t.x),
          (this.cy = t.y),
          (this.r = t.r || Math.max(Math.log(this.damage), 2)),
          this.r < 1 && (this.r = 1),
          this.r > 6 && (this.r = 6),
          (this.building = t.building || null),
          (this.map = t.map || this.building.map),
          (this.type = t.type || 1),
          (this.color = t.color || "#000"),
          this.map.bullets.push(this),
          this.addToScene(this.map.scene, 1, 6),
          1 == this.type && this.caculate();
      },
      caculate: function () {
        var i,
          e,
        ...
        (i = h - this.cx),
          (e = a - this.cy),
          (s = Math.sqrt(Math.pow(i, 2) + Math.pow(e, 2))),
          (n = 20 * this.speed * t.global_speed),
          (this.vx = (i * n) / s),
          (this.vy = (e * n) / s);
      },
      ...
      checkHit: function () {
        var i = this.cx,
          ...
          n = this.map.anyMonster(function (t) {
            return (
              Math.pow(t.cx - i, 2) + Math.pow(t.cy - e, 2) <=
              2 * Math.pow(t.r + s, 2)
            );
          });
        return n
          ? (n.beHit(this.building, this.damage),
            (this.is_valid = !1),
            t.Explode(this.id + "-explode", {
              cx: this.cx,
              cy: this.cy,
              r: this.r,
              step_level: this.step_level,
  ...
  _TD.a.push(function (t) {
    var i = {
      _init: function (i) {
        (i = i || {}),
          (this.is_monster = !0),
          (this.idx = i.idx || 1),
          (this.difficulty = i.difficulty || 1);
        var e = t.getDefaultMonsterAttributes(this.idx);
        (this.speed = Math.floor(
          (e.speed + this.difficulty / 2) * (0.5 * Math.random() + 0.75)
        )),
          this.speed < 1 && (this.speed = 1),
          this.speed > i.max_speed && (this.speed = i.max_speed),
          (this.life = this.life0 =
            Math.floor(
              e.life * (this.difficulty + 1) * (Math.random() + 0.5) * 0.5
            )),
          this.life < 1 && (this.life = this.life0 = 1),
          (this.shield = Math.floor(e.shield + this.difficulty / 2)),
          this.shield < 0 && (this.shield = 0),
          (this.damage = Math.floor(
            (e.damage || 1) * (0.5 * Math.random() + 0.75)
          )),
          ...
          (this.money =
            ...
            Math.floor(
              Math.sqrt(
                (this.speed + this.life) * (this.shield + 1) * this.damage
              )
            )),
          this.money < 1 && (this.money = 1),
          (this.color = e.color || t.lang.rndRGB()),
          (this.r = Math.floor(1.2 * this.damage) * _TD.retina),
          this.r < 4 * _TD.retina && (this.r = 4 * _TD.retina),
          this.r > t.grid_size / 2 - 4 * _TD.retina &&
            (this.r = t.grid_size / 2 - 4 * _TD.retina),
      ...
      beHit: function (i, e) {
        if (this.is_valid) {
          var s = Math.ceil(0.1 * e);
          (e -= this.shield),
            s >= e && (e = s),
            (this.life -= e),
            (t.score += Math.floor(Math.sqrt(e))),
            this.life <= 0 && this.beKilled(i);
          var n = this.scene.panel.balloontip;
          n.el == this &&
            (n.text = t._t("monster_info", [
              this.life,
              this.shield,
              this.speed,
              this.damage,
      ...
      checkFinish: function () {
        this.grid &&
          this.map &&
          this.grid == this.map.exit &&
          ((t.life -= this.damage),
          (t.wave_damage += this.damage),
          t.life <= 0
            ? ((t.life = 0), t.stage.gameover())
            : (this.pause(), this.del()));
      },
      ...
      getToward: function () {
        this.grid &&
          this.next_grid &&
          (this.grid.my < this.next_grid.my
            ? (this.toward = 0)
            : this.grid.mx < this.next_grid.mx
            ? (this.toward = 1)
            : this.grid.my > this.next_grid.my
            ? (this.toward = 2)
            : this.grid.mx > this.next_grid.mx && (this.toward = 3));
      },
      getNextGrid: function () {
        (0 == this.way.length || Math.random() < 0.1) && this.findWay();
        var t = this.way.shift();
        t &&
          !this.map.checkPassable(t[0], t[1]) &&
          (this.findWay(), (t = this.way.shift())),
          t && (this.next_grid = this.map.getGrid(t[0], t[1]));
      },
      ...
      beBlocked: function () {
        this.is_blocked ||
          ((this.is_blocked = !0), t.log("monster be blocked!"));
      },
      step: function () {
        if (this.is_valid && !this.is_paused && this.grid) {
          if (!this.next_grid && (this.getNextGrid(), !this.next_grid))
            return void this.beBlocked();
          if (this.cx == this.next_grid.cx && this.cy == this.next_grid.cy)
            ...
            Math.abs(i) < h && Math.abs(e) < h
              ? ((this.cx = this.next_grid.cx),
                (this.cy = this.next_grid.cy),
                (this._dx = h - Math.abs(i)),
                (this._dy = h - Math.abs(e)))
              : ((this.cx += 0 == i ? 0 : s * (h + this._dx)),
                (this.cy += 0 == e ? 0 : n * (h + this._dy)),
                (this._dx = 0),
                (this._dy = 0));
          }
          this.caculatePos();
    ...
    var e = {
      _init: function (i) {
        ...
        (this.cx = i.cx),
          (this.cy = i.cy),
          (this.r = i.r * _TD.retina),
          (this.step_level = i.step_level),
          (this.render_level = i.render_level),
          (this.rgb_r = e[0]),
          (this.rgb_g = e[1]),
          (this.rgb_b = e[2]),
          (this.rgb_a = 1),
          (this.wait = this.wait0 = t.exp_fps * (i.time || 1)),
          i.scene.addElement(this);
      },
      step: function () {
        this.is_valid &&
          (this.wait--,
  ...
  _TD.a.push(function (t) {
    var i = {
      _init: function (i) {
        ...
        this.addToScene(this.scene, 1, 7),
          e.addToScene(this.scene, 1, 7, e.grids),
          (this.scene.panel_map = e),
          (this.gameover_obj = new t.GameOver("panel-gameover", {
            panel: this,
            scene: this.scene,
            step_level: this.step_level,
            is_visiable: !1,
          ...
          (this.btn_pause = new t.Button("panel-btn-pause", {
            scene: this.scene,
            x: this.x,
            ...
            onClick: function () {
              1 == this.scene.state
                ? (this.scene.pause(),
                  (this.text = t._t("button_continue_text")),
                  this.scene.panel.btn_upgrade.hide(),
                  this.scene.panel.btn_sell.hide(),
                  this.scene.panel.btn_restart.show())
                : 2 == this.scene.state &&
                  (this.scene.start(),
                  (this.text = t._t("button_pause_text")),
                  this.scene.panel.btn_restart.hide(),
                  this.scene.map.selected_building &&
                    (this.scene.panel.btn_upgrade.show(),
                    this.scene.panel.btn_sell.show()));
            },
          })),
      ...
      step: function () {
        t.life_recover &&
          ((this._life_recover = this._life_recover2 = t.life_recover),
          (this._life_recover_wait = this._life_recover_wait2 = 3 * t.exp_fps),
          (t.life_recover = 0)),
          this._life_recover &&
            t.iframe % t.exp_fps_eighth == 0 &&
            (t.life++, this._life_recover--);
      },
      render: function () {
        var i = t.ctx;
        if (
          ...
          i.beginPath(),
          i.fillText(t._t("panel_money_title") + t.money, this.x, this.y),
          i.fillText(
            t._t("panel_score_title") + t.score,
            this.x,
            this.y + 20 * _TD.retina
          ),
          i.fillText(
            t._t("panel_life_title") + t.life,
            this.x,
            this.y + 40 * _TD.retina
          ),
          i.fillText(
            t._t("panel_building_title") + this.map.buildings.length,
            this.x,
            this.y + 60 * _TD.retina
          ),
          i.fillText(
            t._t("panel_monster_title") + this.map.monsters.length,
            this.x,
            this.y + 80 * _TD.retina
          ),
          i.fillText(
            t._t("wave_info", [this.scene.wave]),
            this.x,
            this.y + 210 * _TD.retina
          ),
          i.closePath(),
          this._life_recover_wait)
        ) {
          var e = this._life_recover_wait / this._life_recover_wait2;
          (i.fillStyle = "rgba(255, 0, 0, " + e + ")"),
            (i.font = "bold " + 12 * _TD.retina + "px 'Verdana'"),
            i.beginPath(),
            i.fillText(
              "+" + this._life_recover2,
              this.x + 60 * _TD.retina,
              this.y + 40 * _TD.retina
            ),
            i.closePath(),
            this._life_recover_wait--;
        ...
        (i.textAlign = "right"),
          ...
          i.fillText(
            "version: " + t.version,
            t.stage.width - t.padding,
            t.stage.height - 2 * t.padding
          ),
          i.closePath(),
          (i.textAlign = "left"),
          (i.fillStyle = "#666"),
    ...
    var e = {
      ...
      caculatePos: function () {
        ...
        (this.x = i.cx + 0.5),
          (this.y = i.cy + 0.5),
          this.x + this.width > this.scene.stage.width - t.padding &&
      ...
      msg: function (i, e) {
        this.text = i;
        var s = t.ctx;
        (s.font = "normal " + 12 * _TD.retina + "px 'Courier New'"),
          (this.width = Math.max(
            s.measureText(i).width + 10 * _TD.retina,
            6 * t.lang.strLen2(i) + 10 * _TD.retina
          )),
          (this.height = 20 * _TD.retina),
          e && e.cx && e.cy && ((this.el = e), this.caculatePos(), this.show());
      },
      step: function () {
        return this.el && this.el.is_valid
          ? void (this.el.is_monster && this.caculatePos())
          : void this.hide();
      },
      render: function () {
        if (this.el) {
          var i = t.ctx;
          (i.lineWidth = _TD.retina),
            (i.fillStyle = "rgba(255, 255, 0, 0.5)"),
            (i.strokeStyle = "rgba(222, 222, 0, 0.9)"),
            i.beginPath(),
            i.rect(this.x, this.y, this.width, this.height),
            i.closePath(),
            i.fill(),
            i.stroke(),
            (i.textAlign = "left"),
            ...
            (i.font = "normal " + 12 * _TD.retina + "px 'Courier New'"),
            i.beginPath(),
            i.fillText(this.text, this.px, this.py),
            i.closePath();
        }
      },
    };
    ...
    var s = {
      _init: function (i) {
        (i = i || {}),
          (this.text = i.text),
          (this.onClick = i.onClick || t.lang.nullFunc),
          (this.x = i.x),
          (this.y = i.y),
          (this.width = i.width || 80 * _TD.retina),
          (this.height = i.height || 30 * _TD.retina),
      ...
      onEnter: function () {
        t.mouseHand(!0),
          this.desc && this.scene.panel.balloontip.msg(this.desc, this);
      },
      onOut: function () {
        t.mouseHand(!1),
          this.scene.panel.balloontip.el == this &&
      ...
      render: function () {
        var i = t.ctx;
        (i.lineWidth = 2 * _TD.retina),
          (i.fillStyle = this.is_hover ? "#eee" : "#ccc"),
          (i.strokeStyle = "#999"),
          i.beginPath(),
          i.rect(this.x, this.y, this.width, this.height),
          i.closePath(),
          ...
          (i.font = "normal " + 12 * _TD.retina + "px 'Courier New'"),
          i.beginPath(),
          i.fillText(this.text, this.font_x, this.font_y),
          i.closePath(),
          i.fill();
      },
    };
    ...
    var n = {
      ...
      render: function () {
        ...
        (i.textAlign = "center"),
          ...
          (i.fillStyle = "#ccc"),
          (i.font = "bold 62px 'Verdana'"),
          i.beginPath(),
          i.fillText("GAME OVER", this.width / 2, this.height / 2),
          i.closePath(),
          (i.fillStyle = "#f00"),
          (i.font = "bold 60px 'Verdana'"),
          i.beginPath(),
          i.fillText("GAME OVER", this.width / 2, this.height / 2),
          i.closePath();
      },
  ...
  _TD.a.push(function (t) {
    var i = function () {
        ...
        (this.config = s.config),
          (t.life = this.config.life),
          (t.money = this.config.money),
          (t.score = this.config.score),
          (t.difficulty = this.config.difficulty),
          (t.wave_damage = this.config.wave_damage);
        var n = new t.Map(
          "main-map",
          t.lang.mix(
            {
      ...
      e = function () {
        var i = this.current_act.current_scene,
          e = i.wave;
        if (
          (0 != e || this.map.has_weapon) &&
          1 == i.state &&
          0 == this.map.monsters.length
        ) {
          if (e > 0 && this.wait_new_wave == this.config.wait_new_wave - 1) {
            var s = 0;
            e % 10 == 0 ? (s = 10) : e % 5 == 0 && (s = 5),
              t.life + s > 100 && (s = 100 - t.life),
              s > 0 && t.recover(s);
          }
      ...
      if (this.is_valid && this.grid) {
        ...
        if (
          ...
          (i.fillStyle = "#000"),
            ...
            i.beginPath(),
            i.fillRect(
              this.cx - e + _TD.retina,
              this.cy - this.r - (6 - _TD.retina),
              (this.life * s) / this.life0,
              2 * _TD.retina
            ),
            i.closePath();
        }
    ...
    var e = {
      ...
      wall: function (t, i, e, s, n) {
        (i.lineWidth = _TD.retina),
          ...
          i.beginPath(),
          i.moveTo(t.cx - n + 0.5, t.cy - n + 0.5),
          i.lineTo(t.cx - n + 0.5, t.cy + n + 0.5),
          i.lineTo(t.cx + n + 0.5, t.cy + n + 0.5),
          i.lineTo(t.cx + n + 0.5, t.cy - n + 0.5),
          i.lineTo(t.cx - n + 0.5, t.cy - n + 0.5),
          i.moveTo(t.cx - n + 0.5, t.cy + n + 0.5),
    ...
    (t._msg_texts = {
      ...
      (t._t = t.translate =
        function (t, i) {
          ...
          var e,
            s = this._msg_texts[t] || this._msg_texts._,
            n = i.length;
      ...
      (t.FindWay.prototype = {
        _init: function () {
          if (this.x1 == this.x2 && this.y1 == this.y2)
            return (
              (this.is_arrived = !0), void (this.way = [[this.x1, this.y1]])
            );
        ...
        getNeighborsOf: function (t, i) {
          ...
          return (
            i > 0 && e.push([t, i - 1]),
            t < this.w - 1 && e.push([t + 1, i]),
            i < this.h - 1 && e.push([t, i + 1]),
            t > 0 && e.push([t - 1, i]),
            e
          );
        },
        ...
        findWay: function () {
          for (
            ...
            for (
              this.way.unshift([l, r]),
                e = this.getNeighborsOf(l, r),
                i = e.length,
                a = [],
                o = -1,
                s = 0;
              ...
              (h = this.getVal(e[s][0], e[s][1])),
                0 > h || ((0 > o || o > h) && (o = h));
            for (s = 0; i > s; s++)
              (t = e[s]), o == this.getVal(t[0], t[1]) && a.push(t);
            (n = a.length),
              (s = n > 1 ? Math.floor(Math.random() * n) : 0),
              (t = a[s]),
              (l = t[0]),
              (r = t[1]);
          }
        ...
        next: function () {
          var t,
            ...
            s,
            n,
            h = this.getAllNeighbors(),
            a = h.length,
            l = [];
          for (this.distance++, s = 0; a > s; s++)
            if (
              ((t = h[s]),
              (i = t[0]),
              (e = t[1]),
