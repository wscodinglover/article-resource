...
```
<span data-darkreader-inline-bgcolor=""></span><code data-darkreader-inline-color="" data-darkreader-inline-bgimage="" data-darkreader-inline-bgcolor="">tar&nbsp;-xvf&nbsp;/www/server/mypack/nasm-2.16.01.tar.gz&nbsp;#解压到当前目录<br><span data-darkreader-inline-color="">#</span><span>&nbsp;tar&nbsp;-xvf&nbsp;/www/server/mypack/nasm-2.16.01.tar.gz&nbsp;-C&nbsp;/指定目录</span><br></code>
```
