...
var zrxName1 = new Array(
  "青龙<font color=#FF8C1A>(黄道日)</font>",
  "明堂<font color=#FF8C1A>(黄道日)</font>",
  "天刑<FONT color=#0000A0>(黑道日)</font>",
  "朱雀<FONT color=#0000A0>(黑道日)</font>",
  "金匮<font color=#FF8C1A>(黄道日)</font>",
  "天德<font color=#FF8C1A>(黄道日)</font>",
  "白虎<FONT color=#0000A0>(黑道日)</font>",
  "玉堂<font color=#FF8C1A>(黄道日)</font>",
  "天牢<FONT color=#0000A0>(黑道日)</font>",
  "玄武<FONT color=#0000A0>(黑道日)</font>",
  "司命<font color=#FF8C1A>(黄道日)</font>",
  "勾陈<FONT color=#0000A0>(黑道日)</font>"
);
var zrxName2 = new Array(
  "司命<font color=#FF8C1A>(黄道日)</font>",
  "勾陈<FONT color=#0000A0>(黑道日)</font>",
  "青龙<font color=#FF8C1A>(黄道日)</font>",
  "明堂<font color=#FF8C1A>(黄道日)</font>",
...
function jcr(d) {
  ...
  if (d == "建")
    jcrjx =
      "<FONT color=green>　<b>宜</b>：</font>出行.上任.会友.上书.见工<br><FONT color=red>　<b>忌</b>：</font>动土.开仓.嫁娶.纳采";
  if (d == "除")
    jcrjx =
      "<FONT color=green>　<b>宜</b>：</font>除服.疗病.出行.拆卸.入宅<br><FONT color=red>　<b>忌</b>：</font>求官.上任.开张.搬家.探病";
  if (d == "满")
    jcrjx =
      "<FONT color=green>　<b>宜</b>：</font>祈福.祭祀.结亲.开市.交易<br><FONT color=red>　<b>忌</b>：</font>服药.求医.栽种.动土.迁移";
  if (d == "平")
    jcrjx =
      "<FONT color=green>　<b>宜</b>：</font>祭祀.修坟.涂泥.余事勿取<br><FONT color=red>　<b>忌</b>：</font>移徙.入宅.嫁娶.开市.安葬";
  if (d == "定")
    jcrjx =
      "<FONT color=green>　<b>宜</b>：</font>交易.立券.会友.签约.纳畜<br><FONT color=red>　<b>忌</b>：</font>种植.置业.卖田.掘井.造船";
  if (d == "执")
    jcrjx =
      "<FONT color=green>　<b>宜</b>：</font>祈福.祭祀.求子.结婚.立约<br><FONT color=red>　<b>忌</b>：</font>开市.交易.搬家.远行";
  if (d == "破")
    jcrjx =
      "<FONT color=green>　<b>宜</b>：</font>求医.赴考.祭祀.余事勿取<br><FONT color=red>　<b>忌</b>：</font>动土.出行.移徙.开市.修造";
  if (d == "危")
    jcrjx =
      "<FONT color=green>　<b>宜</b>：</font>经营.交易.求官.纳畜.动土<br><FONT color=red>　<b>忌</b>：</font>登高.行船.安床.入宅.博彩";
  if (d == "成")
    jcrjx =
      "<FONT color=green>　<b>宜</b>：</font>祈福.入学.开市.求医.成服<br><FONT color=red>　<b>忌</b>：</font>词讼.安门.移徙";
  if (d == "收")
    jcrjx =
      "<FONT color=green>　<b>宜</b>：</font>祭祀.求财.签约.嫁娶.订盟<br><FONT color=red>　<b>忌</b>：</font>开市.安床.安葬.入宅.破土";
  if (d == "开")
    jcrjx =
      "<FONT color=green>　<b>宜</b>：</font>疗病.结婚.交易.入仓.求职<br><FONT color=red>　<b>忌</b>：</font>安葬.动土.针灸";
  if (d == "闭")
    jcrjx =
      "<FONT color=green>　<b>宜</b>：</font>祭祀.交易.收财.安葬<br><FONT color=red>　<b>忌</b>：</font>宴会.安床.出行.嫁娶.移徙";
  return jcrjx;
}
...
function CalConv2(yy, mm, dd, y, d, m, dt, nm, nd) {
  ...
  if (
    ...
    return "<FONT color=#0000A0><center>日值岁破 大事不宜</center></font>";
  } else if (
    (mm == 0 && dd == 6) ||
    (mm == 6 && dd == 0) ||
    (mm == 1 && dd == 7) ||
    ...
    return "<FONT color=#0000A0><center>日值月破 大事不宜</center></font>";
  } else if (
    (y == 0 && dy == "911") ||
    (y == 1 && dy == "55") ||
    (y == 2 && dy == "111") ||
    ...
    return "<FONT color=#0000A0><center>日值上朔 大事不宜</center></font>";
  } else if (
    (m == 1 && dt == 13) ||
    (m == 2 && dt == 11) ||
    (m == 3 && dt == 9) ||
    ...
    return "<FONT color=#0000A0><center>日值杨公十三忌 大事不宜</center></font>";
  } else {
    return 0;
  }
}
  ...
  if (document.all && document.readyState == "complete") {
    ...
    if (tips > 2) {
      ...
      if (tips == 1) {
        ...
        jie4 = tqyb[xing];
        if (jie4 == undefined) {
          text = "<center><p>&nbsp;</p><p>对不起！暂无天气数据</p>";
          ht = "-140";
        } else {
          text =
    ...
    if (tips != 2) {
      document.all.tip2.innerHTML =
        "<table cellSpacing=1 cellPadding=0 bgColor=#f7f7f7 border=1><tr><td bgColor=#ffffff><table cellSpacing=1 cellPadding=0 bgColor=#e5e5e5 border=0><tr><td bgColor=#ffffff><table cellSpacing=1 cellPadding=0 bgColor=#b2b2b2 border=0><tr><td bgColor=#ffffff><table cellpadding=3 cellspacing=10 bgcolor=" +
        bt +
        " width=" +
        wt +
        '><tr><td style="font-size: 9pt" height=' +
        pt +
        "><font color=#800080>" +
        text +
        "</font>" +
    ...
    if (tip2x < document.body.scrollLeft) {
      tip2x = window.event.clientX + 20;
    }
    var tip2y = window.event.clientY - ht;
    if (tip2y < document.body.scrollTop) {
      tip2y = window.event.clientY + 20;
    }
    if (document.all) {
